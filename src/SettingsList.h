...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr,
  ...
  static const std::vector<SettingInfo> baseList = [] {
    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_LANDSCAPE_SIDE_BTN, &CrossPointSettings::landscapeSideButtons,
                          {StrId::STR_LANDSCAPE_SIDE_AS_PORTRAIT, StrId::STR_LANDSCAPE_SIDE_HOLD_PREV},
                          "landscapeSideButtons", StrId::STR_CAT_CONTROLS),
